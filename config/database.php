    ...
    */
    ...
    'connections' => [
        ...
        'maite' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('IVX_HOST', '127.0.0.1'),
            'port' => env('IVX_PORT', '3306'),
            'database' => env('IVX_DATABASE', 'forge'),
            'username' => env('IVX_USERNAME', 'forge'),
            'password' => env('IVX_PASSWORD', ''),
            'unix_socket' => env('IVX_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'meet' => [
            ...
            'port' => env('MEET_PORT', '3306'),
            'database' => env('MEET_DATABASE', 'forge'),
            'username' => env('MEET_USERNAME', 'forge'),
            'password' => env('MEET_PASSWORD', ''),
            'unix_socket' => env('MEET_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
