...
// API Controllers
    ...
    use App\Http\Middleware\SwitchDatabaseMiddleware; /* Cambio Entre Bases de Datos */
// API Controllers End
...
//Meet Controllers
    ...
    /* Events Controller */
    use App\Http\Controllers\Meets\MeetEventsController; /* Controlador de Eventos */

/* end */

// AutoSchedule Controllers
    use App\Http\Controllers\AutoSchedule\DoctorsController; /* Contt¿rolador de Medicos */
    use App\Http\Controllers\AutoSchedule\SpecialtiesController; /* Controlador de Especialidades */
    use App\Http\Controllers\AutoSchedule\DiariesController; /* Controlador de Horas Agenda */
    use App\Http\Controllers\AutoSchedule\AppointmentsController; /* Controlador de Citas Medicas */
...
/* Aqui Terminan las Rutas de la API */
